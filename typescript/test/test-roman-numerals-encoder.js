...
describe('Roman numerals encoder solution', function () {
    it('basic', function () {
...
describe('RomanNumeralsEncoderHelper', function () {
    ...
    it('Split simple number', function () {
        var testData = [1, 5, 10, 50, 100, 500, 1000];
        var expectedPowerRepresentations = [
            new Main_1.PowerRepresentation(1, 1),
            new Main_1.PowerRepresentation(5, 1),
            new Main_1.PowerRepresentation(1, 10),
            new Main_1.PowerRepresentation(5, 10),
            new Main_1.PowerRepresentation(1, 100),
            new Main_1.PowerRepresentation(5, 100),
            new Main_1.PowerRepresentation(1, 1000)
        ];
        testData.forEach(function (value, index) {
            var actual = Main_1.RomanNumeralsEncoderHelper.getPowerRepresentationMap(value);
            chai_1.assert.isNotNull(actual, 'should not be NULL');
            chai_1.assert.lengthOf(actual, 1, 'length should be 1');
            chai_1.assert.deepEqual(actual[0], expectedPowerRepresentations[index], "Representation of \"" + value + "\" should be: " + expectedPowerRepresentations[index].toString());
        });
    });
    it('Split complex number', function () {
        var testData = [5342, 6854];
        var expectedPowerRepresentationMaps = [
            [
                new Main_1.PowerRepresentation(5, 1000),
                new Main_1.PowerRepresentation(3, 100),
                new Main_1.PowerRepresentation(4, 10),
                new Main_1.PowerRepresentation(2, 1)
            ],
            [
                new Main_1.PowerRepresentation(6, 1000),
                new Main_1.PowerRepresentation(8, 100),
                new Main_1.PowerRepresentation(5, 10),
                new Main_1.PowerRepresentation(4, 1)
            ],
        ];
        testData.forEach(function (value, index) {
            var actual = Main_1.RomanNumeralsEncoderHelper.getPowerRepresentationMap(value);
            chai_1.assert.lengthOf(actual, expectedPowerRepresentationMaps[index].length, "Length of \"" + value + "\" should be " + expectedPowerRepresentationMaps[index].length);
            actual.forEach(function (elem, id) {
                chai_1.assert.deepEqual(elem, expectedPowerRepresentationMaps[index][id], "Representation of \"" + elem.toString() + "\" should be: " + expectedPowerRepresentationMaps[index][id]);
            });
        });
    });
    it('Get symbol by correct value', function () {
        var testData = [1, 5, 10, 50, 100, 500, 1000];
        var expectedSymbols = ['I', 'V', 'X', 'L', 'C', 'D', 'M'];
        testData.forEach(function (value, index) {
            var actual = Main_1.RomanNumeralsEncoderHelper.getCorrectSymbol(value);
            chai_1.assert.equal(actual, expectedSymbols[index], "Symbol should be " + expectedSymbols[index]);
        });
    });
    it('Get symbol by incorrect value', function () {
        chai_1.expect(function () { return Main_1.RomanNumeralsEncoderHelper.getCorrectSymbol(3); }).to.throw('There is no representation for "3"');
    });
    it('Check valid value', function () {
        [1, 5, 10, 50, 100, 500, 1000].forEach(function (value) {
            chai_1.assert.isTrue(Main_1.RomanNumeralsEncoderHelper.isValidValue(value), "Value \"" + value + "\" should be valid");
        });
    });
    it('Check invalid value', function () {
        [3, 7, 11].forEach(function (value) {
            chai_1.assert.isFalse(Main_1.RomanNumeralsEncoderHelper.isValidValue(value), "Value \"" + value + "\" should be invalid");
        });
    });
    it('Get valid power representation of a simple value', function () {
        var testData = [
            new Main_1.PowerRepresentation(2, 1),
            new Main_1.PowerRepresentation(3, 1),
            new Main_1.PowerRepresentation(4, 1),
            new Main_1.PowerRepresentation(6, 1),
            new Main_1.PowerRepresentation(7, 1),
            new Main_1.PowerRepresentation(8, 1),
            new Main_1.PowerRepresentation(9, 1)
        ];
        var expectedPowerRepresentationMaps = [
            [
                new Main_1.PowerRepresentation(1, 1),
        ...
        testData.forEach(function (value, index) {
            var actual = Main_1.RomanNumeralsEncoderHelper.getValidPowerRepresentationMap(value);
            var expected = expectedPowerRepresentationMaps[index];
            chai_1.assert.lengthOf(actual, expected.length, "Length of \"" + value.toString() + "\" should be " + expected.length);
            actual.forEach(function (elem, id) {
                chai_1.assert.deepEqual(elem, expected[id], "Representation of \"" + elem.toString() + "\" should be " + expected[id].toString());
            });
        });
        // let actual = RomanNumeralsEncoderHelper.getValidPowerRepresentationMap(new PowerRepresentation(2, 1));
        // expect(actual).to.have.lengthOf(2, 'length should be 2');
        ...
        // expect(actual).to.have.lengthOf(3, 'length should be 3');
        // expect(actual[0].Value).to.equal(1, 'value should be 1');
        // expect(actual[0].Power).to.equal(1, 'power should be 1');
        // expect(actual[1].Value).to.equal(1, 'value should be 1');
        // expect(actual[1].Power).to.equal(1, 'power should be 1');
        ...
        // expect(actual).to.have.lengthOf(4, 'length should be 4');
        // expect(actual[0].Value).to.equal(5, 'value should be 5');
        // expect(actual[0].Power).to.equal(1, 'power should be 1');
        // expect(actual[1].Value).to.equal(1, 'value should be 1');
        // expect(actual[1].Power).to.equal(1, 'power should be 1');
...
},{"./Main":1,"chai":4}],3:[function(require,module,exports){
/*!
 * assertion-error
...
},{"./flag":18,"assertion-error":3,"type-detect":40}],18:[function(require,module,exports){
/*!
 * Chai - flag utility
 * Copyright(c) 2012-2014 Jake Luer <jake@alogicalparadox.com>
 * MIT Licensed
